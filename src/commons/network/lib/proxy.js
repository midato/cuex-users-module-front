...
import { PROXY_USER, PROXY_PWD, PROXY_ENDPOINT } from '../../const'
...
export const getProxyToken = async () => {
  ...
  const response = await axiosClient({ url: PROXY_ENDPOINT, method: 'post', data: formBody, headers, myCustomParam: 'test' })
